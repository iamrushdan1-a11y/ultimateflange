...
<body class="bg-slate-50 text-slate-900">
        ...
        <div class="bg-white w-full max-w-md rounded-3xl shadow-2xl overflow-hidden p-4 sm:p-6 md:p-8 relative" style="max-height: 90vh; overflow-y: auto;">
            ...
            <div id="login-form">
                ...
                <form id="loginForm" class="space-y-4 md:space-y-5">
                    ...
                    <button type="button" onclick="handleVisitorMode()" 
            ...
            <div id="signup-form" class="hidden">
                ...
                <form id="signupForm" class="space-y-4 md:space-y-5">
    ...
    <div id="order-modal" class="fixed inset-0 bg-black/60 backdrop-blur-md hidden items-center justify-center p-4 z-50">
        <div class="bg-white w-full max-w-2xl rounded-3xl shadow-2xl overflow-hidden relative" style="max-height: 90vh; overflow-y: auto;">
            ...
            <div class="px-4 md:px-8 pt-6 md:pt-8">
                <div class="flex items-center justify-between mb-6 md:mb-8">
                    <div class="flex items-center gap-2 md:gap-4">
                        <div id="step-indicator-1" class="step-indicator w-8 h-8 md:w-10 md:h-10 rounded-full bg-blue-600 text-white flex items-center justify-center font-bold active text-sm md:text-base">1</div>
                        <div id="step-indicator-2" class="step-indicator w-8 h-8 md:w-10 md:h-10 rounded-full bg-slate-200 text-slate-500 flex items-center justify-center font-bold text-sm md:text-base">2</div>
                        <div id="step-indicator-3" class="step-indicator w-8 h-8 md:w-10 md:h-10 rounded-full bg-slate-200 text-slate-500 flex items-center justify-center font-bold text-sm md:text-base">3</div>
                        <div id="step-indicator-4" class="step-indicator w-8 h-8 md:w-10 md:h-10 rounded-full bg-slate-200 text-slate-500 flex items-center justify-center font-bold text-sm md:text-base">4</div>
                    </div>
            ...
            <div id="order-step-1" class="p-4 md:p-8">
                <div class="text-center mb-6 md:mb-8">
                    <h2 class="text-2xl md:text-3xl font-bold text-slate-900">Order Request - Step 1</h2>
                ...
                <form class="space-y-4 md:space-y-5">
                    <div>
                        ...
                        <select id="order-product" class="w-full px-3 md:px-4 py-2.5 md:py-3 rounded-xl border-2 border-slate-200 focus:ring-2 focus:ring-blue-500 outline-none transition text-sm md:text-base">
                    ...
                    <div class="grid md:grid-cols-2 gap-4 md:gap-5">
                        <div>
                            ...
                            <input type="number" min="1" value="1" id="order-quantity" class="w-full px-3 md:px-4 py-2.5 md:py-3 rounded-xl border-2 border-slate-200 focus:ring-2 focus:ring-blue-500 outline-none transition text-sm md:text-base">
                        </div>
                        <div>
                            <label class="block text-sm font-semibold text-slate-700 mb-2">Size / Dimensions *</label>
                            <input type="text" id="order-size" placeholder="e.g., 10-inch, DN250" class="w-full px-3 md:px-4 py-2.5 md:py-3 rounded-xl border-2 border-slate-200 focus:ring-2 focus:ring-blue-500 outline-none transition text-sm md:text-base">
                        </div>
                    </div>
                    
                    <div>
                        <label class="block text-sm font-semibold text-slate-700 mb-2">Material Specification *</label>
                        <select id="order-material" class="w-full px-3 md:px-4 py-2.5 md:py-3 rounded-xl border-2 border-slate-200 focus:ring-2 focus:ring-blue-500 outline-none transition text-sm md:text-base">
                    ...
                    <div>
                        ...
                        <textarea rows="3" id="order-specs" class="w-full px-3 md:px-4 py-2.5 md:py-3 rounded-xl border-2 border-slate-200 focus:ring-2 focus:ring-blue-500 outline-none transition text-sm md:text-base" placeholder="Pressure rating, surface finish, coating, etc."></textarea>
                    </div>
                    
                    <button type="button" onclick="nextOrderStep(2)" class="w-full py-3 md:py-4 bg-gradient-to-r from-blue-600 to-blue-800 text-white font-bold rounded-xl hover:from-blue-700 hover:to-blue-900 transition-all shadow-lg text-sm md:text-base">
            ...
            <div id="order-step-2" class="p-4 md:p-8 hidden">
                <div class="text-center mb-6 md:mb-8">
                    <h2 class="text-2xl md:text-3xl font-bold text-slate-900">Order Request - Step 2</h2>
                ...
                <form class="space-y-4 md:space-y-5">
                    <div class="grid md:grid-cols-2 gap-4 md:gap-5">
                        <div>
                            <label class="block text-sm font-semibold text-slate-700 mb-2">First Name *</label>
                            <input type="text" id="order-firstname" required class="w-full px-3 md:px-4 py-2.5 md:py-3 rounded-xl border-2 border-slate-200 focus:ring-2 focus:ring-blue-500 outline-none transition text-sm md:text-base">
                        </div>
                        <div>
                            <label class="block text-sm font-semibold text-slate-700 mb-2">Last Name *</label>
                            <input type="text" id="order-lastname" required class="w-full px-3 md:px-4 py-2.5 md:py-3 rounded-xl border-2 border-slate-200 focus:ring-2 focus:ring-blue-500 outline-none transition text-sm md:text-base">
                        </div>
                    </div>
                    ...
                    <div class="grid md:grid-cols-2 gap-4 md:gap-5">
                        <div>
                            <label class="block text-sm font-semibold text-slate-700 mb-2">Email *</label>
                            <input type="email" id="order-email" required class="w-full px-3 md:px-4 py-2.5 md:py-3 rounded-xl border-2 border-slate-200 focus:ring-2 focus:ring-blue-500 outline-none transition text-sm md:text-base">
                        </div>
                        <div>
                            <label class="block text-sm font-semibold text-slate-700 mb-2">Phone *</label>
                            <input type="tel" id="order-phone" required class="w-full px-3 md:px-4 py-2.5 md:py-3 rounded-xl border-2 border-slate-200 focus:ring-2 focus:ring-blue-500 outline-none transition text-sm md:text-base">
                        </div>
                    </div>
                    
                    <div>
                        <label class="block text-sm font-semibold text-slate-700 mb-2">Company *</label>
                        <input type="text" id="order-company" required class="w-full px-3 md:px-4 py-2.5 md:py-3 rounded-xl border-2 border-slate-200 focus:ring-2 focus:ring-blue-500 outline-none transition text-sm md:text-base">
                    </div>
                    
                    <div>
                        <label class="block text-sm font-semibold text-slate-700 mb-2">Delivery Address</label>
                        <textarea rows="3" id="order-address" class="w-full px-3 md:px-4 py-2.5 md:py-3 rounded-xl border-2 border-slate-200 focus:ring-2 focus:ring-blue-500 outline-none transition text-sm md:text-base" placeholder="Full address for delivery"></textarea>
                    </div>
                    ...
                    <div class="flex gap-3 md:gap-4">
                        <button type="button" onclick="prevOrderStep(1)" class="flex-1 py-2.5 md:py-3.5 bg-slate-200 text-slate-700 font-bold rounded-xl hover:bg-slate-300 transition text-sm md:text-base">
                            <i class="fas fa-arrow-left mr-2"></i>Back
                        </button>
                        <button type="button" onclick="nextOrderStep(3)" class="flex-1 py-2.5 md:py-3.5 bg-gradient-to-r from-blue-600 to-blue-800 text-white font-bold rounded-xl hover:from-blue-700 hover:to-blue-900 transition text-sm md:text-base">
            ...
            <div id="order-step-3" class="p-4 md:p-8 hidden">
                <div class="text-center mb-6 md:mb-8">
                ...
                <div class="bg-slate-50 rounded-2xl p-4 md:p-6 mb-4 md:mb-6">
                    <h4 class="font-bold text-slate-800 mb-3 md:mb-4">Order Summary</h4>
                ...
                <div class="bg-blue-50 rounded-2xl p-4 md:p-6 mb-4 md:mb-6">
                ...
                <div class="flex gap-3 md:gap-4">
                    <button type="button" onclick="prevOrderStep(2)" class="flex-1 py-2.5 md:py-3.5 bg-slate-200 text-slate-700 font-bold rounded-xl hover:bg-slate-300 transition text-sm md:text-base">
                        <i class="fas fa-arrow-left mr-2"></i>Back
                    </button>
                    <button type="button" onclick="submitOrder()" class="flex-1 py-2.5 md:py-3.5 bg-gradient-to-r from-green-600 to-green-800 text-white font-bold rounded-xl hover:from-green-700 hover:to-green-900 transition shadow-lg text-sm md:text-base">
            ...
            <!-- Step 4: Confirmation -->
            <div id="order-step-4" class="p-4 md:p-8 hidden">
                <div class="text-center py-6 md:py-8">
                    ...
                    <h2 class="text-2xl md:text-3xl font-bold text-slate-900 mb-3 md:mb-4">Request Sent to Supplier!</h2>
                    
                    <div class="bg-slate-50 rounded-2xl p-4 md:p-6 mb-4 md:mb-6">
                        <p class="text-slate-700 mb-3 md:mb-4">
                    ...
                    <div class="text-sm text-slate-500 mb-4 md:mb-6">
                        Order Reference: <strong id="order-reference">UF-ORD-${Date.now().toString().slice(-6)}</strong>
                    </div>
                    
                    <div class="bg-yellow-50 border border-yellow-200 rounded-xl p-3 md:p-4 mb-4 md:mb-6">
                    ...
                    <button onclick="closeOrderModal()" class="w-full py-2.5 md:py-3.5 bg-gradient-to-r from-blue-600 to-blue-800 text-white font-bold rounded-xl hover:from-blue-700 hover:to-blue-900 transition text-sm md:text-base">
    ...
    <div id="mobile-menu" class="mobile-menu">
        ...
        <div class="space-y-4 px-6">
            ...
            <a href="#" onclick="toggleMobileMenu(); trackOrder();" class="block text-slate-700 hover:text-blue-600 font-medium py-3 border-b border-slate-100">Track Order</a>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between h-20 items-center">
                    ...
                    <div class="hidden lg:flex space-x-8 font-medium text-sm items-center">
                        ...
                        <a href="#" onclick="trackOrder()" class="hover:text-blue-600 transition text-slate-700 font-medium">Track Order</a>
    ...
    <script>
        ...
        document.getElementById('signupForm').addEventListener('submit', async function(event) {
            ...
            if (!firstName || !lastName || !email || !password || !company || !industry) {
                showNotification('Please fill all required fields', 'error');
                return;
            }
            
            // Determine user type based on current selection
            const userType = currentUserType.toUpperCase(); // 'PARTNER' or 'SUPPLIER'
            
            await registerUser(firstName, lastName, email, password, company, industry, userType);
        });
        ...
        async function loginUser(email, password) {
            ...
            try {
                ...
                if (response.ok) {
                    ...
                    handleAuthSuccess(data, currentUserType);
                } else {
                    // Handle error
        ...
        async function registerUser(firstName, lastName, email, password, company, industry, userType) {
            const loader = document.getElementById('transition-loader');
            loader.style.left = '0%';
        ...
        function handleAuthSuccess(userData, userType) {
            // Update global state
        ...
        function trackOrder() {
            ...
            showNotification('Order tracking feature is under development.', 'info');
        }
